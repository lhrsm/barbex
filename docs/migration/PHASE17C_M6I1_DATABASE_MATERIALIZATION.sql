-- ==============================================================================
-- BARBEX — PHASE 17C.M6I.1: TARGET SUPABASE MATERIALIZATION ARTIFACT
-- TARGET PROJECT: ywdwrstxvsdqiryhieiz
-- TARGET URL: https://ywdwrstxvsdqiryhieiz.supabase.co
--
-- CRITICAL SAFETY DIRECTIVE:
-- APPLY TO TARGET (ywdwrstxvsdqiryhieiz) ONLY.
-- NEVER EXECUTE ON SOURCE PRODUCTION (wdxhjwodyctgzqtogkgv).
-- ==============================================================================

BEGIN;

-- ------------------------------------------------------------------------------
-- 1. PUBLIC PLATFORM SETTINGS RPC
-- ------------------------------------------------------------------------------
...
-- ------------------------------------------------------------------------------
-- 3. SUPER ADMIN UPGRADE RECOMMENDATIONS RPC
-- ------------------------------------------------------------------------------
